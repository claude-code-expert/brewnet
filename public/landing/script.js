  ...
  var commands = [
    {
      ...
      output: [
        ...
        '<span class="out-green">&#10003;</span> <span class="out-bold">Domain</span> <span class="out-muted">— my-server.example.com + Cloudflare Tunnel</span>',
        ...
        '  Dashboard  <span class="out-cyan">https://my-server.example.com</span>',
        '  Nextcloud  <span class="out-cyan">https://files.my-server.example.com</span>',
        '  Gitea      <span class="out-cyan">https://git.my-server.example.com</span>',
      ]
    },
    {
      cmd: 'brewnet status',
      output: [
        ...
        '<span class="out-green">traefik</span>        <span class="out-green">running</span>     80/443  <span class="out-cyan">my-server.example.com</span>',
        '<span class="out-green">postgresql</span>     <span class="out-green">running</span>     5432    <span class="out-muted">internal</span>',
        '<span class="out-green">nextcloud</span>      <span class="out-green">running</span>     8080    <span class="out-cyan">files.my-server.example.com</span>',
        '<span class="out-green">gitea</span>          <span class="out-green">running</span>     3000    <span class="out-cyan">git.my-server.example.com</span>',
    ...
    },
    {
      ...
      output: [
        ...
        '<span class="out-green">&#10003;</span> Route: <span class="out-cyan">https://media.my-server.example.com</span>',
        '',
